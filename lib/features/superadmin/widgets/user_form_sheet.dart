              ...
              child: Row(
                children: [
                  Container(
                    ...
                    child: const Icon(Iconsax.user_add, size: 18, color: Colors.white),
                  ),
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        Text('Nuevo Usuario', style: AppTypography.textTheme.titleLarge),
                        Text('Crea un acceso para la aplicación', style: AppTypography.caption),
                      ],
                    ),
                  ),
                  IconButton(
                    ...
                    TextFormField(
                      ...
                      decoration: InputDecoration(
                        ...
                        suffixIcon: IconButton(
                          ...
                          icon: Icon(_obscurePass ? Iconsax.eye_slash : Iconsax.eye, size: 18),
                        ),
                      ),
                      validator: (v) {
